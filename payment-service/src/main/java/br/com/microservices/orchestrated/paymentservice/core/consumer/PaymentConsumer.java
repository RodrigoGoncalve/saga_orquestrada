...
import br.com.microservices.orchestrated.paymentservice.core.service.PaymentSevice;
...
public class PaymentConsumer {
    ...
    public void consumeSuccessEvent(String payload) {
        ...
        this.paymentSevice.realizePayment(event);
    }
    ...
    public void consumeFailEvent(String payload) {
        ...
        var event = jsonUtil.toEvent(payload);
        this.paymentSevice.realizeRefund(event);
    }

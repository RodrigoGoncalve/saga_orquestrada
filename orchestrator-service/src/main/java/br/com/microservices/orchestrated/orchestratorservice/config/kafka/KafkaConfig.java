...
public class KafkaConfig {
    ...
    private Map<String, Object> consumerProps(){
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServes);
    ...
    private Map<String, Object> producerProps(){
        var props = new HashMap<String, Object>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServes);
    ...
    @Bean
    public NewTopic orchestratorToppic(){
        return buildTopic(BASE_ORCHESTRATOR.getTopic());
    }

    @Bean
    public NewTopic finishiSuccessTopic(){
        return buildTopic(FINISH_SUCCESS.getTopic());
    }

    @Bean
    public NewTopic finishiFailTopic(){
